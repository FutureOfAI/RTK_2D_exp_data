...
%     for i_1=1:30 
        ...
        pos(2,j_1) = (bitshift(data_new(4,j_1),8)+data_new(5,j_1))/1024 + 0.536;
        pos(3,j_1) = (bitshift(data_new(6,j_1),8)+data_new(7,j_1))/1024 + 0.59;
        pos(4,j_1) = (bitshift(data_new(8,j_1),8)+data_new(9,j_1))/1024 - 0.26;        
        if row == 44
            pos(5,j_1) = (bitshift(data_new(10,j_1),8)+data_new(11,j_1))/1024 + 2.05;
            pos(6,j_1) = (bitshift(data_new(12,j_1),8)+data_new(13,j_1))/1024 + 2;
...
if row == 44
    ...
    subplot(611)
    plot(1:count_for-500,pos(1,1:count_for-500))
    xlabel('time')
    ylabel('Anchor1 distance (m)')
    subplot(612)
    plot(1:count_for-500,pos(2,1:count_for-500))
    xlabel('time')
    ylabel('Anchor2 distance (m)')
    subplot(613)
    plot(1:count_for-500,pos(3,1:count_for-500))
    xlabel('time')
    ylabel('Anchor3 distance (m)')
    subplot(614)
    plot(1:count_for-500,pos(4,1:count_for-500))
    xlabel('time')
    ylabel('Anchor4 distance (m)')
    subplot(615)
    plot(1:count_for-500,pos(5,1:count_for-500))
    xlabel('time')
    ylabel('Anchor5 distance (m)')
    subplot(616)
    plot(1:count_for-500,pos(6,1:count_for-500))
    xlabel('time')
    ylabel('Anchor6 distance (m)')
end
